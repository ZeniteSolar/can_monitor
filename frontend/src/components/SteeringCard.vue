    ...
    <div class="steering-body px-2 pb-2 pt-1">
      <v-card-text class="d-flex justify-center pa-0">
        <svg :width="svgWidth" :height="svgHeight" :viewBox="`0 0 ${svgWidth} ${svgHeight}`"
          ...
          <mask id="rectMask">
            <rect :x="cx - radius - 70" y="0" :width="radius * 2 + 140" :height="svgHeight" rx="10" ry="10"
              fill="white" />
          ...
          <!-- Boat label -->
          <rect :x="cx - 50" :y="svgHeight - 35" width="100" height="30" rx="5" ry="5" fill="white" stroke="black"
            stroke-width="1" />
          <text :x="cx" :y="svgHeight - 15" text-anchor="middle" fill="black" font-family="sans-serif" font-size="16">
            Guarapuvu II
          </text>
...
// match speedometer’s width, shrink height to ≈80%
const svgWidth = 250;
const svgHeight = 120;
// pick a radius that fits in 120px tall (formerly 100 in 150px)
const radius = 80;
